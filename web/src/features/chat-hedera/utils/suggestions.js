...
export const suggestions = [
  ...
  {
    id: "web-search-hederacon",
    category: "web-search",
    label: "Latest from HederaCon",
    prompt: "What happened at the most recent HederaCon conference?",
    mutating: false,
  },
  {
    id: "web-search-hashgraph",
    category: "web-search",
    label: "Explain what HashSpheres are",
    prompt: "Research HashSpheres and explain what they are",
    mutating: false,
  },
];
